...
<sup>1</sup>You will receive warnings by email, and as a pop-up and in the [**Billing & Usage**](https://console.particle.io/billing) tab in the console at 70%, 90%, and 100% of the allowable data operations. In the Free Plan you will have an opportunity to upgrade to the Basic/plus plan. In the Basic/plus plan, additional blocks can be added to allow for more data operations.
{{!-- END shared-blurb --}}
