...
Check out the [Publish](/reference/device-os/firmware/#particle-publish-),  [Subscribe](/reference/device-os/firmware/#particle-subscribe-), and [Webhooks](/tutorials/device-cloud/webhooks/) documentation for more information.
...
Particle.publish("temperature", temperature, PRIVATE); // publish to cloud
```
This line publishes an **event** named "temperature" to the Particle cloud, which brings with it the data stored in the `temperature` variable. You can read more about publishing events [here](/reference/device-os/firmware/#particle-publish-).
