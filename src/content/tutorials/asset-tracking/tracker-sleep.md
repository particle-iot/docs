...
This is the power consumption for the Tracker One 523 in normal operating mode vs. [ultra-low-power sleep mode](/reference/device-os/firmware/#ultra_low_power-systemsleepmode-).
