...
Connect the device to your computer using USB and put the device in [listening mode](/troubleshooting/led/#listening-mode) (blinking dark blue) by holding down the SETUP (or MODE) button until the main status LED blinks dark blue, about 3 seconds.
...
Put the device in [listening mode](/troubleshooting/led/#listening-mode) (blinking dark blue) by holding down the SETUP button until the main status LED blinks dark blue, about 3 seconds, if it's not already in that state.
...
Connect the device to your phone using a USB cable and a USB OTG adapter and put the device in [listening mode](/troubleshooting/led/#listening-mode) (blinking dark blue) by holding down the SETUP (or MODE) button until the main status LED blinks dark blue, about 3 seconds.
