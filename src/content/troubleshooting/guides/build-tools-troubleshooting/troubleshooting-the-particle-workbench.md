...
* On Mac and Linux, if Workbench is installed within a user directory, ensure there is **no whitespace** within the filepath of that directory (e.g. /Users/Particle Support/).
