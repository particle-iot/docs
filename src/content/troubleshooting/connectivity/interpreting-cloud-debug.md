...
Some carriers have stopped supporting 2G. You can find out more information in [the 2G/3G sunset guide](/getting-started/hardware/cellular-overview/#2g-and-3g-sunset). 
...
If you are using a 3rd-party SIM card, the model may vary. For example, if you are using Optus in Australia, you'd use the U270 instead of the U260. There is more information in [the roaming guide](/getting-started/hardware/cellular-overview/#roaming).
