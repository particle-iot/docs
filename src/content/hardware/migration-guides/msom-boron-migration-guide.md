...
**The M-SoM requires significantly more current than the Boron** and may require modifications to your power supply.
...
- In `HIBERNATE` sleep mode, the M-SoM can only be wakened by certain pins, but the Boron and Argon can be wakened by any pin.
