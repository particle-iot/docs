...
The M-SoM has peak power usage that is higher than the E-Series SoM. Be sure the check the guidelines below carefully.
{{box op="end"}}

As the M-SoM does not include a built-in power supply like the E-Series SoM, you may want to consider using the
...
The E-Series module includes a built-in PMIC and 3V3 regulator, but you must provide your own with the M-SoM.
...
**The M-SoM requires significantly more peak current than the E-Series**.
...
| 002      | 2025-01-07 | RK | Added power supply notes |
