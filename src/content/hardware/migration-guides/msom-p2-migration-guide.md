...
The M-SoM has peak power usage that is higher than the P2. Be sure the check the guidelines below carefully.
{{box op="end"}}

As the M-SoM requires dual supply voltages, you may want to consider using the
