...
- Deploy your instance. You don't need to add services to it first; the Node-RED app itself contains everything you need to run it. When complete you'll get a URL to connect to with your instance.

- Be sure to follow the instructions for security your cloud-hosted instance!
