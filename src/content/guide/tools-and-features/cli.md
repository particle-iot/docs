...
To use the local flash and key features you'll also need to install [dfu-util](https://github.com/Stefan-Schmidt/dfu-util), and [openssl](http://www.openssl.org/).  They are freely available and open-source, and there are installers and binaries for most major platforms.
