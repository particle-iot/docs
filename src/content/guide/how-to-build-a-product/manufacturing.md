...
You have two options when it comes to purchasing Particle hardware--purchasing from Particle, and purchasing directly from our module manufacturer. Let's run through the pro's and con's of each:
...
- **Purchasing from our module manufacturer.** If your order volumes for the P0 or P1 are very large (50-100K), and you prefer to manage your own supply chain relationships, we encourage you to place an order directly to our module manufacturer. A company named [USI](http://www.usish.com/english/default.php) in Taiwan manufacturers the P0 and P1, and we'd be happy to provide all necessary introductions to get your purchase order submitted.
...
**1. Serial communication**. Although exposing the serial communication lines to your Photon/P0/P1 is not a strict requirement of products build with Particle hardware, it's highly encouraged and makes gathering test results from your product during testing much simpler.
