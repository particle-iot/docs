...
####Photon/P0
- IC ID: **20127-PHOTON**. Search [here](https://sms-sgs.ic.gc.ca/equipmentSearch/searchRadioEquipments) under "Certification Number".
...
####P1 Module
- IC ID: **2056-WIZFI250**. Search [here](https://sms-sgs.ic.gc.ca/equipmentSearch/searchRadioEquipments) under "Certification Number".  
- Certificate of Conformity
- Test Report
