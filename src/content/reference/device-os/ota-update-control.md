...
Reset control occurs entirely on device and does not depend on events being sent to the cloud, so it saves on data and data operations, but also provides less visibility in the console that restart will be deferred.
