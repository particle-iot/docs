...
For more information, check out the [Internet Button datasheet](/reference/datasheets/accessories/legacy-accessories/#internet-button).
...
You should be able to fork the examples from the Particle Web IDE or copy and paste the code from the GitHub repo or from this page. We recommend going through these examples in order for the best understanding of how the Internet Button works. If you haven't used Particle Build before, read the [Particle Web IDE guide](/getting-started/developer-tools/build/).

**If you copy and paste these examples, make sure that you include the official Internet Button library before flashing the code.** Instructions on how to include a library can be found [here](/getting-started/device-os/firmware-libraries/).
