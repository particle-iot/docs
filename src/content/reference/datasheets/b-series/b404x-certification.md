...
{{imageOverlay src="/assets/images/b-series/r510-block-diagram.png" alt="R510 Block Diagram" class="full-width"}}

- The B404X contains a u-blox SARA-R510S cellular modem module.
- Only the SIM, UART are used in normal options. 
- USB to the R510 is provided for debugging only via the M.2 interface; no connector is provided.
- DDC (I2C), SPI, SDIO, and I2S are not connected to the module.
...
- SARA-R5 series modules include a UE Power Class 3 LTE Cat M1 transmitter and an LTE receiver, with output power and characteristics according to 3GPP TS 36.521-1.
- The SARA-R410S hardware also supports LTE Cat NB1, this is also disabled in Device OS and cannot be enabled from user firmware.

#### LTE operating bands

- Frequency ranges for each LTE band as per 3GPP TS 36.521-1

| Parameter | Uplink Min | Uplink Max | Downlink Min | Downlink Max | Unit |
| :--- | :--- | :--- | :--- | :--- | :--- |
| FDD band 12 (700 MHz) | 699 | 716 | 729 | 746 | MHz |
| FDD band 13 (750 MHz) | 777 | 787 | 746 | 756 | MHz |
| FDD band 5 (850 MHz) | 824 | 849 | 869 | 894 | MHz |
| FDD band 4 (1700 MHz) | 1710 | 1755 | 2110 | 2155 | MHz |
| FDD band 2 (1900 MHz) | 1850 | 1910 | 1930 | 1990 | MHz |

#### Receive characteristics 

- Receiver input sensitivity, without repetitions:

| Parameter | Typical | Unit |
| :--- | :--- | :--- |
| Band 12 (700 MHz) | -110.5 | dBm |
| Band 13 (750 MHz) | -110.5 | dBm |
| Band 5 (850 MHz)  | -110.0 | dBm |
| Band 4 (1700 MHz) | -109.0 | dBm |
| Band 2 (1900 MHz) | -109.0 | dBm |

- SARA-R5 series modules LTE receiver characteristics are compliant to 3GPP TS 36.521-1
- Condition: 50 ohm source, throughput > 95%, QPSK modulation, other settings as per clause 7.3EA of 3GPP TS 36.521-1

### Nordic nRF52840 MCU

{{imageOverlay src="/assets/images/b-series/nRF52-block-diagram.png" alt="nRF52840 Block Diagram" class="full-width"}}

- The B404X contains a Nordic nRF52840 MCU which contains BLE and NFC radios.
- While the nRF52840 hardware supports other radio technologies such as OpenThread (6LoWPAN over IEEE 802.15.4) and BLE Mesh, the nRF52 SoftDevice firmware that is included on the B404X does not include these features and there is no way to enable them from user firmware.
...
| 030      | 2023-02-14 | RK | Updated information for certification |
