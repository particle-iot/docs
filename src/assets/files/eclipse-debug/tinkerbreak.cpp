...
int breakHandler(String command);
int divHandler(String command);
...
void setup()
{
    ...
    Particle.function("break", breakHandler);
    Particle.function("div", divHandler);
...
int divHandler(String command) {
	int div = (int) command.toInt();

	// This will cause a divide-by-zero error when 0 is passed in the data
	int result = 1000 / div;
