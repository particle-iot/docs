 ...
 * with more explanatory documentation, example routines, how to
 * hook up your pixels and all of the pixel types that are supported.
 **
 * On the Argon, Boron, B-SoM, and Tracker, only these pins can be used for Neopixel:
 * - D2, D3, A4, A5
 * - D4, D6, D7, D8
 * - A0, A1, A2, A3
 *
 ...
 *
 * On Photon 1, Electron, P1, any pin can be used for Neopixel.
 */
