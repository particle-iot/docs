        ...
        */
        ...
        //
        {
            ...
            const hatchBackgroundImages = {
                backward: 'repeating-linear-gradient(45deg, #000000, #000000 2px, transparent 2px, transparent 8px)',
                forward: 'repeating-linear-gradient(135deg, #000000, #000000 2px, transparent 2px, transparent 8px)',
                cross: 'repeating-linear-gradient(45deg, #000000, #000000 2px, transparent 2px, transparent 8px), repeating-linear-gradient(135deg, #000000, #000000 2px, transparent 2px, transparent 8px)',
            };
