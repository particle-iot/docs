...
You can find more details about the product ID and how to get yours in the [_Console_ guide.](https://docs.particle.io/guide/tools-and-features/console/#your-product-id)
