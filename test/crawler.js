...
function classifyUrl(item) {
  var info = {
    ...
    githubEditLink: item.url.indexOf('https://github.com/particle-iot/docs/tree/master/src/content') === 0,
    ...
    isGithubLink: item.url.indexOf('https://github.com') === 0
  };
  return info;
}
...
describe('Crawler', function() {
  ...
  it('should complete without error', function(done) {
    ...
    function fetchResultError(queueItem, response) {
      ...
      if (queueItem.stateData.code=== 403 && urlis.isGithubLink) {
    	  // Github is randomly returning 403 errors for some reason. Treat as warning, not error.
    	  isWarning = true;
      }
