...
- `--generate` Generates data files in the docs repository (this also does --generate-index)
- `--generate-index` Generates an abbreviated index of libraries in src/assets/files/libraryIndex.json
